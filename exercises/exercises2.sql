...
DROP DATABASE HOTEL;
-- usuniêcie bazy danych jeœli istnieje
...
INSERT INTO Pokoje
	(ID, RodzajPokojID, Cena, MaxLiczbaOsob, Opis)
VALUES
	(101, 2, 100, 2, 'bez ³azienki, TV, wifi'),
...
INSERT INTO Firmy
	(Nazwa, NIP, KodPocztowy, Miasto, Adres)
VALUES
	('Blachotrapez Sp. z o.o.', '9931742334', '30-215', 'Rabka Zdrój', 'ul. Na wzgórzu 42'),
...
INSERT INTO Klienci
	(Imie, Nazwisko, PESEL, Email, Telefon, FirmaID)
VALUES
	('Barbara', 'Fibiana', '75092908342', 'barbara.fibiana@onet.pl', '884317743', NULL),
...
INSERT INTO [Rezerwacje]
	(KlientID, PokojID, DataRezerwacji, DataPrzyjazdu, DataWyjazdu, StatusID)
VALUES
	('8', '102', '2017-09-01', '2018-04-19', '2018-04-26', 4),
...
INSERT INTO [Rabaty]
	(KlientID, FirmaID, ObowiazujeOd, Procent)
VALUES
	(17, NULL, '2018-02-28', 10),
...
INSERT INTO Pobyty
	(RezerwacjaID, KlientID, PokojID, DataPrzyjazdu, DataWyjazdu)
SELECT ID, KlientID, PokojID, DataPrzyjazdu, DataWyjazdu
FROM Rezerwacje
WHERE Rezerwacje.[StatusID] = 6
...
BEGIN
	INSERT INTO Zguby
		(ID, Nazwa, Opis, DataZnalezienia, PokojID, Pracownik, CzyOdebrano)
	VALUES
		(@ID, @Nazwa, @Opis, @DataZnalezienia, @PokojID, @Pracownik, @CzyOdebrano)
END
