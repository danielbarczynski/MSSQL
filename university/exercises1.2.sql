...
left join students_modules sm on sm.module_id = m.module_id 
left join employees e on m.lecturer_id=e.employee_id -- nie inner join,poniewaz w modules lecturer_id moze byc null i mogloby ich nie dolaczyc innerem
where student_id is null order by m.module_id asc
